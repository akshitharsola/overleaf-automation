                ...
                <div className="text-sm text-green-800 space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p>• Footnotes explain abbreviations</p>
          ...
          {activeTab === 'preview' && parsedContent && (
            <div className="space-y-6">
              ...
              <div className="bg-yellow-50 p-4 rounded-lg">
                <h4 className="font-semibold text-yellow-900 mb-2">🎯 IEEE Transformation Success!</h4>
                <div className="text-sm text-yellow-800 space-y-2">
                  <p><strong>✨ Your wide table has been optimized for IEEE single-column format!</strong></p>
                  <p><strong>📏 Smart abbreviations applied:</strong> Long content automatically shortened</p>
                  <p><strong>📊 Space optimized:</strong> Headers and content fit perfectly</p>
